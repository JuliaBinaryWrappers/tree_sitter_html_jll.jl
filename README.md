# `tree_sitter_html_jll.jl` (v0.16.0+0)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl). The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/feddfc2f3c4d7c008e0dfc9a27073f15a29a3fe9/T/tree_sitter_html/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.

For more details about JLL packages and how to use them, see `BinaryBuilder.jl` [documentation](https://juliapackaging.github.io/BinaryBuilder.jl/dev/jll/).

## Sources

The tarballs for `tree_sitter_html_jll.jl` have been built from these sources:

* compressed archive: https://github.com/tree-sitter/tree-sitter-html/archive/v0.16.0.tar.gz (SHA256 checksum: `2ddef4999fd1213746d0b16ac4bf54f56983332e0288a795129fd9bb2a4012b4`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/feddfc2f3c4d7c008e0dfc9a27073f15a29a3fe9/T/tree_sitter_html/bundled)

## Platforms

`tree_sitter_html_jll.jl` is available for the following platforms:
...
* `LibraryProduct`: `libtreesitter_html`
