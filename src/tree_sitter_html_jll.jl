...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_html_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3890dd07-cc9a-5220-ba41-7d914d0b28d4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter_html", artifacts_toml) for e in artifacts["tree_sitter_html"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter_html; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module tree_sitter_html_jll
