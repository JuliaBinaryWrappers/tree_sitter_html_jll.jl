# Autogenerated wrapper script for tree_sitter_html_jll for x86_64-unknown-freebsd11.1-cxx03
...
const libtreesitter_html_splitpath = ["lib", "libtreesitter_html.so"]
...
const libtreesitter_html = "libtreesitter_html.so"
